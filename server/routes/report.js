...
import { 
    reportPlatform,getReport,getPlatformReport,deleteReport, getAllManagedPlatform, deleteManyPlatformReport,getQuizReport, deleteManyQuizReport, deleteQuizReport
...
router.delete("/deleteQuizReport/:id",deleteQuizReport)
