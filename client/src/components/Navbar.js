...
function AppNavbar() {
  ...
  const handleCloseCreatePlatform = useCallback(() => {
    setShowCreatePlatform(false);
  }, []);
  const handleShowCreatePlatform = () => {
  ...
  return (
    <Navbar
      ...
      bg="dark"
      variant="dark"
      style={{ minWidth: "1300px !important;" }}
    >
      <Container>
        <LinkContainer to="/">
          <Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav" class="ml-auto">
          {auth.isAuthenticated ? (
              ...
              >
                <NavDropdown.Item href="#">
                  <LinkContainer to="/profile">
                    <Nav.Link className="text-white">View Profile</Nav.Link>
                  </LinkContainer>
                </NavDropdown.Item>
                <NavDropdown.Item href="#">
                  <Nav.Link
                    onClick={handleShowCreatePlatform}
            ...
            <Nav.Link onClick={handleShowSignIn} href="">
              Sign In
            </Nav.Link>
          )}
        </Navbar.Collapse>
        ...
        <CreatePlatform
          ...
          handleClose={handleCloseCreatePlatform}
        />
      </Container>
    </Navbar>
  );
