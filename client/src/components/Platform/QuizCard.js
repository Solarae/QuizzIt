...
function QuizCard({ quiz }) {
    ...
    return (
        <Card bg="white" style={{ width: "220px", cursor: "pointer" }} onClick={routeToQuiz} >
            ...
            <Card.Footer style={{ background: "white" }}>
                <small className="text-muted"><i class="bi bi-people-fill"></i> {quiz.submissions.length} Taken<i class="bi bi-dot"></i>5d ago</small>
            </Card.Footer>
        </Card>
    )
}
